...
class theetherlove : public contract {
public:
    theetherlove(account_name self) : contract(self) {}
    ...
    static constexpr uint64_t code = N(theetherlove);
...
//EOSIO_ABI_EX(theetherlove, (init)(scored)(remove)(transfer))
